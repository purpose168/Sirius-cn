...
**Reference**: This issue is documented in our [CHANGELOG.md](https://github.com/purpose168/Sirius-cn/blob/main/CHANGELOG.md) under "Go Module Dependencies: Resolved version conflicts between sirius-api, go-api, and app-scanner modules"
...
**Reference**: For more details, see our updated [README.md](https://github.com/purpose168/Sirius-cn/blob/main/README.md) or [CHANGELOG.md](https://github.com/purpose168/Sirius-cn/blob/main/CHANGELOG.md)
...
**Reference**: See [CHANGELOG.md](https://github.com/purpose168/Sirius-cn/blob/main/CHANGELOG.md) - "RabbitMQ Connectivity: Corrected health check patterns for reliable service monitoring"
...
**Reference**: See [CHANGELOG.md](https://github.com/purpose168/Sirius-cn/blob/main/CHANGELOG.md) for all v0.4.0 improvements.
